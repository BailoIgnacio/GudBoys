...
public class WhatsAppSender implements IRecordatorioStrategy {
    ...
    public String enviarRecordatorio(SeguimientoVisitas seguimiento) {
        // TODO: devolver un mensaje simulado, ej: "Se envió recordatorio por WhatsApp al seguimiento #" + seguimiento.getId()
        return "Se envió recordatorio por WhatsApp al seguimiento #" + seguimiento.getId();
    }
